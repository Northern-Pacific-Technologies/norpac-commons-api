 ...
 */
public class ProductServiceDetailsDeleteApiRequest {

  private UUID idProduct;
  private Timestamp updatedAt;
  private String updatedBy;

  public ProductServiceDetailsDeleteApiRequest () {}

  @Hidden
  public Map<String, Object> getDeleteRequest() {
    
    var request = new LinkedHashMap<String, Object>();
    request.put("sql", "SELECT norpac_commons.d_product_service_details(?,?,?)");
