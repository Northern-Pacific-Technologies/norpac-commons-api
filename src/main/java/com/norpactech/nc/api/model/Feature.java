...
/**
 * API Model Class: Feature - Created feature from Import
 */
public class Feature extends BaseModel {
    ...
    Boolean isActive)
 {
  ...
  public static Map<String, Object> queryRequest(Map<String, String> queryParams) throws Exception {
    ...
    var matchedParams = paramMatcher(queryParams, Feature.class);
    matchedParams.put("sql", 
      "SELECT norpac_commons.feature.* " + 
      "FROM norpac_commons.feature");
